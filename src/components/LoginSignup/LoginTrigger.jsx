            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-center w-9 h-9 rounded-full bg-[#A7A7A7] flex-shrink-0">
                  ...
                  >
                    <path
                      d="M15.6571 16.141C15.6571 13.8578 17.6055 12 20 12C22.3945 12 24.3429 13.8578 24.3429 16.141C24.3429 18.4243 22.3945 20.2821 20 20.2821C17.6055 20.2821 15.6571 18.4243 15.6571 16.141ZM22.7429 21.5897H17.2571C14.3589 21.5897 12 23.839 12 26.6026C12 27.9251 13.1273 29 14.5143 29H25.4857C26.8727 29 28 27.9251 28 26.6026C28 23.839 25.6411 21.5897 22.7429 21.5897Z"
                      fill="#E1E1E1"
                    />
                  </svg>
                </div>
