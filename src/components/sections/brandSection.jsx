          ...
          >
            {providers.map((provider, i) => (
              <motion.div
                ...
                className="flex-shrink-0 w-[25%] sm:w-[140px] sm:h-[60px] h-[50px] bg-black/20 rounded-lg flex items-center justify-center cursor-pointer hover:bg-white/5 transition-all duration-300"
              >
                <img
                  src={provider.logo}
                  alt={provider.name}
